 ...
 * commit them (this is what keeps it reusable outside the analysis page).
 */
@Component({
  selector: 'app-board',
  ...
  template: `
    ...
    >
      <!-- Squares layer -->
      <div class="absolute inset-0 grid grid-cols-8 overflow-hidden rounded-sm shadow-xl ring-2 ring-[#8a3a4e]">
